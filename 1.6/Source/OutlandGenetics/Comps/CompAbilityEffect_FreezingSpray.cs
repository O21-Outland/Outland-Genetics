...
namespace OutlandGenes
{
    public class CompAbilityEffect_FreezingSpray : CompAbilityEffect
	{
		...
		public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
		{
			...
			GenExplosion.DoExplosion(position, parent.pawn.MapHeld, Props.range, OutlandGenesDefOf.Outland_IceFreeze, null, 30, -1f, null, null, null, null, null, 0f, 1, null, null, 255, false, null, 0f, 1, 0f, false, null, null, new FloatRange(num - 10f, num + 10f), false);
